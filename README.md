...
All options that go beyond the [Basic Smell Options](https://github.com/troessner/reek/wiki/Basic-Smell-Options) should be documented in the corresponding smell type wiki page, but if you want to get a quick and full overview over all possible configurations you can always check out [the `config/default.reek` file in this repository](config/defaults.reek).
